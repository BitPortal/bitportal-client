...
namespace example {
  ...
  static jsi::Object getModule(jsi::Runtime &runtime, const std::string &moduleName) {
    ...
    .callWithThis(runtime, batchedBridge, {jsi::String::createFromUtf8(runtime, moduleName)})
    .asObject(runtime);
    return module;
  }

  void TestBinding::install(jsi::Runtime &runtime, std::shared_ptr<TestBinding> testBinding) {
