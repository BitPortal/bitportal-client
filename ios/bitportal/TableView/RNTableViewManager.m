...
RCT_EXPORT_VIEW_PROPERTY(headerButtonText, NSString)
RCT_EXPORT_VIEW_PROPERTY(headerButtonIcon, NSString)
...
RCT_EXPORT_VIEW_PROPERTY(onAddAccessoryPress, RCTBubblingEventBlock)
...
RCT_EXPORT_VIEW_PROPERTY(onScrollViewDidEndDecelerating, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onCollectionViewDidSelectItem, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onMoreAccessoryPress, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onChange, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onLeadingSwipe, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onTrailingSwipe, RCTBubblingEventBlock)
...
RCT_CUSTOM_VIEW_PROPERTY(canLoadMore, BOOL, RNTableView) {
    view.canLoadMore = [RCTConvert BOOL:json];
}
...
RCT_EXPORT_METHOD(scrollCollectonViewToItem:(nonnull NSNumber *)reactTag
                  ...
                  animated:(BOOL)animated)
{
    [self.bridge.uiManager addUIBlock:
     ^(__unused RCTUIManager *uiManager, NSDictionary *viewRegistry){
         ...
         if ([tableView isKindOfClass:[RNTableView class]]) {
             [tableView scrollCollectonViewToItem:itemIndex index:index section:section animated:animated];
         } else {
             RCTLogError(@"Cannot scrollCollectonViewToItem: %@ (tag #%@) is not RNTableView", tableView, reactTag);
         }
     }];
}
@end
