...
const AssetBalanceTableViewCell = props => (
  <View style={{ flex: 1, justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', paddingLeft: 16, opacity: props.data.switching ? 0.4 : 1 }}>
    <View style={{ width: '60%', flexDirection: 'row' }}>
      {!!props.data.chain && <FastImage
        source={assetIcons[props.data.chain.toLowerCase()]}
        style={{ width: 40, height: 40, marginRight: 10, borderRadius: 20, borderWidth: 0.5, borderColor: 'rgba(0,0,0,0.2)' }}
      />}
