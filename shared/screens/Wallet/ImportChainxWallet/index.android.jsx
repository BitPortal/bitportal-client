...
export default class importChainxWallet extends Component {
          ...
          rightButtons: [
            {
              ...
              fontWeight: '400',
              color: 'white',
              enabled: !this.state.invalid && !this.state.pristine && !this.state.importChainxPrivateKeyLoading
            }
          ]
        }
      })
  ...
  onModalHide = () => {
    const error = this.state.importChainxPrivateKeyError
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <IndicatorModal isVisible={this.state.importChainxMnemonicsLoading} message="获取帐户中..." onModalHide={this.onModalHide} onModalShow={this.onModalShow} />
      </View>
    )
  }
}
