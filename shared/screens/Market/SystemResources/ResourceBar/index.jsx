    ...
    return (
      <View style={[styles.container, { backgroundColor: Colors.mainThemeColor }, { ...extraStyle }]}>
        <LinearGradientContainer
          type="right"
          colors={colors}
          style={[styles.container, { alignItems: 'center', width: percent * (FLOATING_CARD_WIDTH - 64) }]}
        />
        <Text style={[styles.text12, { marginLeft: mrLeft }]}>{parseInt(truePercent * 100, 10)}%</Text>
      </View>
    )
  }
}
