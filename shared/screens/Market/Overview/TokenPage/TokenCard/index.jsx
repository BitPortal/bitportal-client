          ...
          <View style={styles.cardContainer}>
            <View style={styles.titleWrapper}>
              ...
              >
                ...
                >
                  {locale === 'zh' && tags && tags.get('zh') && tags.get('zh').length !== 0
              ...
              <Text style={styles.text26}>
                {`$ `}
                {
                  <FormattedNumber
                    ...
                    maximumFractionDigits={ticker.get('price_usd') < 10 ? 6 : ASSET_FRACTION.USD}
                    minimumFractionDigits={ticker.get('price_usd') < 10 ? 4 : ASSET_FRACTION.USD}
                  />
                }
              </Text>
