...
Datafeeds.UDFCompatibleDatafeed = function(datafeedURL, updateFrequency) {
  ...
  this._barsPulseUpdater = new Datafeeds.DataPulseUpdater(this, updateFrequency || 10000 * 1000);
...
Datafeeds.UDFCompatibleDatafeed.prototype._initialize = function() {
  ...
  var config = {
    ...
    supports_marks: false,
    supports_timescale_marks: false,
    supported_resolutions: ["1", "5", "15", "30", "60", "180", "360", "720", "D", "W"],
    exchanges: [{
      value: "",
      name: "All Exchanges",
      desc: ""
  ...
  that._setupWithConfiguration(config);
};
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function(symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
  ...
  var ulr = '/charting_library/datafeed/udf/data.json'
