  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <IndicatorModal isVisible={this.state.importRioChainKeystoreLoading} message={t(this,'import_importing')} onModalHide={this.onModalHide} onModalShow={this.onModalShow} />
      </View>
    )
  }
}
