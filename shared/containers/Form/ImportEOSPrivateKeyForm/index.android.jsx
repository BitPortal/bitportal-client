...
@connect(
  state => ({
    ...
    formSyncWarnings: getFormSyncWarnings('importEOSPrivateKeyForm')(state),
    formValues: getFormValues('importEOSPrivateKeyForm')(state)
  }),
  dispatch => ({
...
@reduxForm({ form: 'importEOSPrivateKeyForm', validate, shouldError, warn })

export default class ImportEOSPrivateKeyForm extends Component {
            ...
            rightButtons: [
              {
                ...
                enabled: !this.state.invalid && !this.state.pristine && !this.state.importEOSPrivateKeyLoading
              }
            ]
          }
        })
      ...
      stack: {
        children: [{
          component: {
            ...
            passProps: { from: 'import', form: 'importEOSPrivateKeyForm', field }
          }
        }]
      }
    })
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <IndicatorModal isVisible={this.state.importEOSPrivateKeyLoading} message="导入中..." onModalHide={this.onModalHide} onModalShow={this.onModalShow} />
      </View>
    )
  }
}
