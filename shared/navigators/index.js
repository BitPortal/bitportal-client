...
export const registerScreens = store => {
  ...
  Navigation.registerComponent("BitPortal.ResetPassword", () =>
    screenComponent(ResetPassword, store)
  );
  Navigation.registerComponent("BitPortal.AccountManager", () =>
    screenComponent(AccountManager, store)
  );
  Navigation.registerComponent("BitPortal.ExportEntrance", () =>
    screenComponent(ExportEntrance, store)
  );
  Navigation.registerComponent("BitPortal.ExportKeystore", () =>
    screenComponent(ExportKeystore, store)
  );
  Navigation.registerComponent("BitPortal.ExportPrivateKey", () =>
    screenComponent(ExportPrivateKey, store)
  );
  ...
  Navigation.registerComponent("BitPortal.AccountCreation", () =>
    screenComponent(AccountCreation, store)
  );
  Navigation.registerComponent("BitPortal.AccountSelection", () =>
    screenComponent(AccountSelection, store)
  );
  Navigation.registerComponent("BitPortal.EOSAccountCreation", () =>
    screenComponent(EOSAccountCreation, store)
  );
