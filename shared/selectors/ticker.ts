...
const exchangeFilterSelector = (state: RootState) =>
  state.ticker.get("exchangeFilter");
const currencyFilterSelector = (state: RootState) =>
  state.ticker.get("currencyFilter");
const quoteAssetFilterSelector = (state: RootState) =>
  state.ticker.get("quoteAssetFilter");
const sortFilterListSelector = (state: RootState) =>
  state.ticker.get("sortFilter");
