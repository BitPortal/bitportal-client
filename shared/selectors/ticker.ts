...
export const eosPriceSelector = (state: RootState) => !!state.ticker.get('dataSource').get('BINANCE_SPOT_EOS_USDT') ? state.ticker.get('dataSource').get('BINANCE_SPOT_EOS_USDT').get('price_last') : 0
