...
export const clearKeystoreError = createAction('keystore/CLEAR_ERROR')
export const changePasswordRequested = createAction<ChangePasswordParams>('keystore/CHANGE_PASSWORD_REQUESTED')
export const changePasswordSucceeded = createAction('keystore/CHANGE_PASSWORD_SUCCEEDED')
export const changePasswordFailed = createAction<ErrorMessage>('keystore/CHANGE_PASSWORD_FAILED')
