...
export const getPairListedExchangeRequested = createAction<TickerParams>('ticker/GET_PAIR_LISTED_EXCHANGE_REQUESTED')
export const getPairListedExchangeSucceeded = createAction<TickerResult>('ticker/GET_PAIR_LISTED_EXCHANGE_SUCCEEDED')
export const getPairListedExchangeFailed = createAction<ErrorMessage>('ticker/GET_PAIR_LISTED_EXCHANGE_FAILED')
